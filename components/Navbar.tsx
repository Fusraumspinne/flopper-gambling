...
import { SportsEsports, Home, GridOn, Casino, ScatterPlot, Diamond, MonetizationOn, SportsMma, QueryStats, ChevronLeft, ChevronRight, ShowChart, Shuffle, Cached, TrendingUp, AutoAwesome, Timeline, SmartToy, CatchingPokemon, CardGiftcard, LocalBar, Flare, FlightTakeoff, Lock, Album, Toll, LocalFireDepartment, PrivacyTip, Speed, Category, Logout, Phishing, ArrowDownward, Cake, AccountBalance, MilitaryTech, ChatBubbleOutline, Star, Sailing } from "@mui/icons-material";
...
const games: Game[] = [
  ...
  { name: "Barbarossa", icon: <Sailing className="w-5 h-5" />, href: "/barbarossa" },
